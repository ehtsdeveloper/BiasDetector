...
function EmployeeDisplay() {
  ...
  return (
    <div className="bg-[#E7ECEF] w-screen min-h-screen flex flex-col md:flex-row pt-[50px]"> {/* Ensures the div starts below the header */}
      ...
      <button className="md:hidden left-4 z-50 font-bold bg-[#8B8C89] text-white p-2 rounded-none shadow-lg border-none" onClick={() => setMenuOpen(!menuOpen)}>☰</button>
